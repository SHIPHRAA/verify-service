...
class BinaryClassificationDataset2(Dataset):
    """
...
class BinaryClassificationDataModule2(pl.LightningDataModule):
    """
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        # print(ng_test_path_list)
        print(set(ng_train_path_list) & set(ng_valid_path_list))
        print(set(ok_train_path_list) & set(ok_valid_path_list))
        # print(aibos_real_train_path_list[:10])
        # print(aibos_real_test_path_list[:10])
        # print("ok_train_path_list", len(ok_train_path_list))
        # print("ok_train_path_list", ok_train_path_list)
        # print("ok_train_path_list", ok_train_path_list)
        # print("ok_train_path_list", ok_train_path_list)
        ...
        self.train_dataset = BinaryClassificationDataset2(
            images_list=train_images_list, transform=self.train_transform
        )
        self.valid_dataset = BinaryClassificationDataset2(
            images_list=valid_images_list, transform=self.valid_transform
        )
        self.test_dataset = BinaryClassificationDataset2(
